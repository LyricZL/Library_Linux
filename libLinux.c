...
int main()
{
	int choice,n,x,y=1,c,c1=123;
	char a,d,b[10],b1[10]="hjj";                      //用户名是hjj  密码是123
	struct book *head=NULL;
	while(y){

		system("cls");
        printf("\n\n\n\n\n\n\n");
	    printf("                                                  WHU Library System          \n\n\n");
	    printf("                                               武汉大学图书信息管理系统         \n\n\n\n");
		printf("\n");
		printf("\n");
		printf("         ===1-用户登录===\n");
...
void xiugai(struct book *head)
{
	...
	if(p==NULL){
		...
		case 2:
			printf("请输入新图书名:");
			fgets(p->bname,100,stdin);
			printf("修改成功!\n");
			break;
		case 3:
			printf("请输入新作者名:");
			fgets(p->wname,100,stdin);
			printf("修改成功!\n");
			break;
		case 4:
			printf("请输入新出版社:");
			fgets(p->press,100,stdin);
			printf("修改成功!\n");
			break;
		case 5:
			printf("请输入新类别:");
			fgets(p->sort,100,stdin);
			printf("修改成功!\n");
			break;
		case 6:
			printf("请输入新出版时间:");
